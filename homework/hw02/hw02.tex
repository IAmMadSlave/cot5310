...
\begin{homeworkProblem}
    Solve Sipser exercises (2nd edition) 1.7b, 1.7e, 1.16, 1.19, 1.21.\\ \\
        \textbf{1.7b \& 1.7e} Give state diagrams of NFAs with the specified number of 
            states recognizing each of the following languages. The alphabet 
            is $\{0,1\}$.
            \begin{enumerate}
                \item[b.] $\{w\ |\ contains\ the\ substring\ 0101,\ i.e.,\ w=x0101y\ for\ some\ x\ and\ y\}$ with fives states.
                \item[e.] The language $0^*1^*0^+$ with three states.
            \end{enumerate}
        \textbf{1.16} Use the construction given in Theroem 1.39 to convert the 
            following two nondeterministic finite automata to equivalent deterministic 
            finite automata.
            Include diagrams here. \\
        \textbf{1.19} Use the procedure described in Lemma 1.55 to convert the following 
        ...
        \begin{enumerate}[label=\alph*.]
            ...
            \item $\emptyset^*$
        \end{enumerate}
        \textbf{1.21} Use the procedure described in Lemma 1.60 to convert the following finite automata to regular expressions.\\
        Include diagrams here. 
